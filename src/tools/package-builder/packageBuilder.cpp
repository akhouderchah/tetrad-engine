...
bool MyApp::OnInit()
{
  ...
  {
    new wxSplashScreen(bitmap, wxSPLASH_CENTRE_ON_SCREEN | wxSPLASH_TIMEOUT, 500, NULL,
...
MyFrame::MyFrame() : wxFrame(NULL, wxID_ANY, PROGRAM_NAME)
{
  wxMenu* menuFile = new wxMenu;
  menuFile->Append(FILE_NEW, "&New Package...\tCtrl-N", "Create a new package file");
...
{
  wxMessageBox(_("This program is used to create and modify package files for "
...
{
  static const wxChar* FILETYPES =
      _T("Package files|*.cpk|\
	All files|*.*");

  wxFileDialog* openFileDialog = new wxFileDialog(this, _("Open file"), "", "", FILETYPES,
...
void MyFrame::OnSaveFile(wxCommandEvent& WXUNUSED(event))
{
  ...
  {
    wxMessageBox(_("There was an error in saving the package file!"), _("Save Error"),
                 wxOK | wxICON_ERROR);
